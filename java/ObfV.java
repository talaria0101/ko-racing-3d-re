...
// String constants: ()I | ()Ljava/io/InputStream; | ()Ljava/lang/String; | ()Ljavax/microedition/lcdui/Graphics; | ()Ljavax/microedition/lcdui/Image; | ()V | ()[B | (I)Lcl; | (I)V | (II)Ljavax/microedition/lcdui/Image; | (II)V | (IIII)V
// API references: java/io javax/microedition
public class ObfV extends ObfBv {
    private byte[] a;
    // bytecode 37 bytes, max_stack 2, max_locals 2
    public ObfV(ObfCv v1) {
        super(v1);
