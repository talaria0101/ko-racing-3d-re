...
public class ScoreUpload {
    ...
    public String[] a(String v1) {
        ...
        int v2 = 1;
        v1 = ((String) ScoreUpload.a(v1, v2, null));
        if (ScoreUpload.a(v1, v2, null) != null) goto L17;
        return null;
        L17:
    ...
    public boolean a(int v1) {
        ...
        v1 = ((int) ScoreUpload.a(new java.lang.StringBuffer().append(this.c).append(this.a_arrI[v1]).toString(), v2, null));
        if (ScoreUpload.a(new java.lang.StringBuffer().append(this.c).append(this.a_arrI[v1]).toString(), v2, null) != null) goto L42;
        return 0;
        L42:
        new java.io.ByteArrayInputStream(v1); /* constructor */
