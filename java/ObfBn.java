...
// String constants: ()B | ()I | ()V | ()Z | (B)V | (F)V | (I)V | (I)Z | (II)V | (II)Z | (Lbn;)V | (Lbn;IIII)V
public class ObfBn {
    protected int c;
    protected int d;
    protected int e;
    ...
    protected ObfBn a_bn;
    private boolean c_Z;
    // bytecode 108 bytes, max_stack 2, max_locals 7
    public ObfBn(ObfBn v1, int v2, int v3, int v4, int v5) {
        super();
        this.c = 0;
        this.d = -10000;
        this.e = 0;
