...
// String constants: ()F | ()I | ()V | ()Z | (F)V | (Lbn;IIILp;)V | (Ljavax/microedition/lcdui/Graphics;II)V | (Ljavax/microedition/lcdui/Graphics;IIZ)V | (Ljavax/microedition/lcdui/Graphics;Ljava/lang/String;II)V | <clinit> | <init> | Code
...
public class ObfS extends ObfBi {
    ...
    public ObfS(ObfBn v1, int v2, int v3, int v4, ObfP v5) {
    ...
    public void a(Graphics v1, int v2, int v3) {
        ...
        if (ObfAq.e <= 400) goto L75;
        jt1 = 5; /* join L76 from L71 */
        goto L76;
        L75:
        jt1 = 0; /* join L76 from L75 */
        L76:
        ObfAq.a.a(v1, "<", 10, (((v3 + this.f()) + 7) + jt1));
        if (ObfAq.e <= 400) goto L115;
        jt2 = 5; /* join L116 from L111 */
        goto L116;
        L115:
        jt2 = 0; /* join L116 from L115 */
        L116:
        ObfAq.a.a(v1, ">", (v1.getClipWidth() - 15), (((v3 + this.f()) + 7) + jt2));
        L120:
        return;
    }
