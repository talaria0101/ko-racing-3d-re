...
public class Garage {
    ...
    static {
        ...
        Garage.a = new javax.microedition.lcdui.Image[2];
        Garage.a_Z = false;
        Garage.b = false;
        new byte[6][0] = 48;
        new byte[6][1] = 28;
        ...
        new int[6][0] = (Garage.a_I + 1);
        new int[6][1] = (Garage.a_I + 2);
        new int[6][2] = (Garage.a_I + 1);
        new int[6][3] = (Garage.a_I + 5);
        new int[6][4] = (Garage.a_I + 3);
        new int[6][5] = (Garage.a_I + 5);
        new Obf[I[5][1] = new int[6];
        new int[3][0] = 4;
        new int[3][1] = 0;
        new int[3][2] = 4;
        new Obf[I[5][2] = new int[3];
        new int[3][0] = (Garage.a_I + 4);
        new int[3][1] = Garage.a_I;
        new int[3][2] = (Garage.a_I + 4);
        new Obf[I[5][3] = new int[3];
        new int[2][0] = 4;
        new int[2][1] = (Garage.a_I + 4);
        new Obf[I[5][4] = new int[2];
        Garage.a_arrarrI = new Obf[I[5];
        new int[6][0] = 7;
        new int[6][1] = 7;
        new int[6][2] = 7;
        new int[6][3] = 7;
