...
// String constants: &p= | ()B | ()I | ()Ljava/io/InputStream; | ()Ljava/io/OutputStream; | ()Ljava/lang/String; | ()V | ()[Ljava/lang/String; | (I)Ljava/lang/String; | (I)Ljava/lang/StringBuffer; | (I)V | (I)Z
...
public class ObfDj {
    ...
    public ObfDj() {
        ...
        this.a = new java.lang.StringBuffer().append(ObfAl.b).append("?a=b").toString();
        new java.lang.StringBuffer(); /* constructor */
        this.b = new java.lang.StringBuffer().append(this.a).append("&p=").toString();
        new java.lang.StringBuffer(); /* constructor */
        this.c = new java.lang.StringBuffer().append(ObfAl.b).append("?a=s&s=").toString();
        this.a_arrI = null;
        this.a_String = null;
        return;
    }
    ...
    public String[] a(String v1) {
        ...
        if (ObfAl.a(new java.io.DataInputStream(v1)).compareTo("OK") == 0) goto L49;
        return null;
        L49:
        v2 = v1.readByte();
    ...
    public boolean a(int v1) {
        ...
        if (ObfAl.a(new java.io.DataInputStream(v1)).compareTo("OK") == 0) goto L74;
        return 0;
        L74:
        ObfAl.d(v1.readByte());
        ObfAl.e(v1.readByte());
        ObfAl.f(v1.readByte());
        ObfAl.h((2 - v1.readByte()));
        ObfAl.g(v1.readByte());
