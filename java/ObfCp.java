...
// String constants: ()B | ()I | ()Z | (B)V | (I)I | (I)V | (I)Z | (II)Z | (Lbn;IIII)V | (Lbn;IIILp;)V | (Ljava/io/InputStream;)Ljavax/microedition/lcdui/Image; | (Ljava/lang/String;)Ljava/io/InputStream;
...
public class ObfCp extends ObfBn {
    ...
    public ObfCp(ObfBn v1, int v2, int v3, int v4, int v5) {
        ...
        v1 = ((ObfBn) this);
        this.b = v2;
        new ObfDl(this, 0, 0, v5, ObfAq.b); /* constructor */
        this.a = new ObfDl(this, 0, 0, v5, ObfAq.b);
    ...
    public boolean a(int v1) {
        ...
        return 1;
        L66:
        if (ObfAq.b(v1) == 1) goto L83;
        if (ObfAq.b(v1) != 6) goto L90;
        L83:
        this.a(0);
        return 1;
        L90:
