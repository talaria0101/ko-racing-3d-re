...
public class ObfBu extends ObfCu {
    ...
    public ObfBu(MainCanvas v1, boolean v2) {
        super(v1);
        this.f = true;
        this.a = null;
        this.s = 0;
    ...
    public void p() {
        new java.lang.StringBuffer(); /* constructor */
        new ObfBs(ObfBb.a, Resources.a(new java.lang.StringBuffer().append("/levels/").append(this.a).toString()), ObfBu.a); /* constructor */
        this.a = new ObfBs(ObfBb.a, Resources.a(new java.lang.StringBuffer().append("/levels/").append(this.a).toString()), ObfBu.a);
        return;
    }
    // bytecode 29 bytes, max_stack 2, max_locals 1
    public void o() {
        new java.lang.StringBuffer(); /* constructor */
        ObfBu.a(Resources.a(new java.lang.StringBuffer().append("/levels/").append(this.a).toString()));
        return;
    }
}
