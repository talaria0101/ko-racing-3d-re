...
// String constants: ()Lbj; | ()V | (FF)F | (FF)Lbj; | (FF)Z | (FFFF)Lbj; | (FFFFFFFFF)V | (Ljava/io/InputStream;)I | (Ljava/io/InputStream;)V | <init> | Code | Lbj;
public class ObfA {
    private ObfI[] a;
    ...
    public ObfA(InputStream v1) {
        ...
        L38:
        if (v4 >= 3) goto L92;
        v2[((v3 * 3) + v4)] = (((float) ObfBe.a(v1)) / 100.0f);
