...
// String constants: ()F | ()I | ()Lz; | ()V | ()Z | (F)F | (FF)F | (FF)Lbj; | (FF)V | (I)Lar; | (I)Lbc; | (I)Lbp;
...
public class ObfBm {
    ...
    public ObfBm(ObfBf v1, int v2, int v3, int v4, int v5) {
        ...
        this.p = 0;
        this.q = 0;
        new ObfZ(-1000.0f, -1000.0f); /* constructor */
        this.a_z = new ObfZ(-1000.0f, -1000.0f);
        this.a = v1.a(v2);
        this.a.c();
        this.b = v2;
        this.a_I = v3;
