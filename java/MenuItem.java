...
public class MenuItem extends Widget {
    ...
    public MenuItem(Widget v1, int v2, int v3, int v4, Font v5) {
        this(v1, v2, v3, v4, v5, true);
        return;
    }
    // bytecode 115 bytes, max_stack 6, max_locals 7
    public MenuItem(Widget v1, int v2, int v3, int v4, Font v5, boolean v6) {
        super(v1, v2, v3, 0, 0);
        this.b = 0;
        this.a = null;
        this.b_Z = true;
    ...
    public void a__void(int v1) {
        ...
        L144:
        v1 = ((int) this);
        if (SysUtil.a(this.b).length != 0) goto L163;
        this.f(0);
        return;
        L163:
