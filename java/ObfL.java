...
// String constants: ()I | ()Ljava/lang/String; | ()V | (FFF)V | (I)I | (I)Ljava/lang/StringBuffer; | (I)V | (III)V | (Ljava/io/InputStream;)Ljavax/microedition/lcdui/Image; | (Ljava/lang/String;)Ljava/io/InputStream; | (Ljava/lang/String;)Ljava/lang/StringBuffer; | (Ljava/lang/String;III)V
...
public class ObfL {
    ...
    public ObfL(String v1, int v2, int v3, int v4) {
        ...
        ObfL.a[v2] = javax.microedition.lcdui.Image.createImage(ObfBl.a(new java.lang.StringBuffer().append(v1).append(v2).append(".png").toString()));
        v2 += 1;
        goto L24;
        L69:
        return;
    ...
    public void a(int v1) {
        ...
        this.a_arrarrI[v1][3] = (((ObfAq.f / 2) + this.a_Random.nextInt((ObfAq.f / 2))) - 30);
        return;
    }
    // bytecode 50 bytes, max_stack 3, max_locals 2
    public void b() {
        if (ObfAl.l() == this.f) goto L49;
        if ((ObfAl.l() % 2) == (this.f % 2)) goto L42;
        int v1 = this.b;
        this.b = this.c;
        this.c = v1;
        L42:
