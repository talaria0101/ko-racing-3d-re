...
// String constants: <clinit> | <init> | Code | java/lang/Object | StackMap
public class Triangle {
    ...
    static {
        ...
        Triangle.a_z = new Vec2(0.0f, 0.0f);
        return;
    }
    // bytecode 247 bytes, max_stack 9, max_locals 10
    public Triangle(float v1, float v2, float v3, float v4, float v5, float v6, float v7, float v8, float v9) {
        super();
        this.a = 0.0f;
        this.b = 0.0f;
        this.c = 0.0f;
    ...
    public boolean a(float v1, float v2) {
        Triangle.a_z.b((v1 - this.e), (v2 - this.f));
        v1 = Vec2.a(this.a_bz, Triangle.a_z);
        v2 = Vec2.a(this.b_bz, Triangle.a_z);
