...
// String constants: ()B | ()F | ()I | ()V | ()Z | (F)V | (I)I | (I)V | (I)Z | (IIII)V | (Lbn;IIIIIZ)V | (Ljavax/microedition/lcdui/Graphics;II)V
...
public class ObfCc extends ObfCm {
    ...
    public void a(Graphics v1, int v2, int v3) {
        ...
        int v4 = ((ObfAq.b.a() + 7) + 15);
        this.f(v4);
        int v5 = (v1.getClipHeight() - v4);
        this.e(v1.getClipWidth());
        v1.setColor(3355443);
        ObfAq.a(v1, 0, (v5 + v3), v1.getClipWidth(), v4, 3355443, 6710886, 1);
        v1.setColor(6710886);
    ...
    public boolean a(int v1) {
        ...
        return 0;
        L16:
        if (ObfAq.b(v1) != 5) goto L31;
        v1 = ObfAq.d();
        goto L43;
        L31:
        if (ObfAq.b(v1) != 2) goto L43;
        v1 = ObfAq.c();
        L43:
        return this.a(v1);
    }
