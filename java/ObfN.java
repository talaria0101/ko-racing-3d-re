...
// String constants: ()B | ()I | ()V | (I)V | (I)Z | (II)V | (II)Z | (IIII)V | (IILp;)V | (Lbn;IIIILp;)V | (Ljava/io/InputStream;)Ljavax/microedition/lcdui/Image; | (Ljava/lang/String;)Ljava/io/InputStream;
...
public class ObfN extends ObfCh {
    ...
    public ObfN(int v1, int v2, ObfP v3) {
        ...
        this.b_Z = false;
        this.i = 0;
        this.a = javax.microedition.lcdui.Image.createImage(ObfBl.a("/images/c.png"));
        this.b = javax.microedition.lcdui.Image.createImage(ObfBl.a("/images/r.png"));
        goto L58;
        /* pop: ex_57; */
        L58:
        this.b(1);
    ...
    public void a(Graphics v1, int v2, int v3) {
        ...
        v1.setClip(0, 0, ObfAq.e, ObfAq.f);
