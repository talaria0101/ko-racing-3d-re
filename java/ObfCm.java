...
// String constants: ()B | ()F | ()I | ()Lbn; | ()V | ()Z | (B)V | (F)V | (I)I | (I)V | (I)Z | (II)V
...
public class ObfCm extends ObfBn {
    ...
    public void a(Graphics v1, int v2, int v3) {
        ...
        this.d((this.e + v8));
        L155:
        if (ObfAl.l() != 0) goto L552;
        v1.setClip((this.e() + v2), ((this.e + v3) - v8), this.b(), (this.a() + v8));
        v1.setColor(5592405);
        ObfAq.a(v1, (this.e() + v2), (this.e + v3), this.b(), this.a(), 5592405, 8947848, 1);
        if (this.d == 0) goto L409;
        v1.setColor(10223616);
        ObfAq.a(v1, (this.e() + v2), ((this.e + v3) - v8), this.b(), v8, 10223616, 13565952, 1);
        this.a[0].a(2);
        this.a[0].d(0);
        this.a[0].h();
        ...
        L409:
        v1.setClip((this.e() + v2), (((this.e + v3) + 4) + ObfAq.d), this.b(), ((this.a() - (2 * (4 + ObfAq.d))) - this.m));
        v8 = ObfAq.d;
        int v9 = 1;
        L460:
        ...
        return;
        L552:
        if (ObfAl.l() != 3) goto L945;
        v1.setClip(((this.e + v3) - v8), (this.e() + v2), (this.a() + v8), this.b());
        v1.setColor(5592405);
        ObfAq.a(v1, (this.e + v3), (this.e() + v2), this.a(), this.b(), 5592405, 8947848, 0);
        if (this.d == 0) goto L807;
        v1.setColor(10223616);
        ObfAq.a(v1, ((this.e + v3) - v8), (this.e() + v2), v8, this.b(), 10223616, 13565952, 0);
        this.a[0].a(2);
        this.a[0].d(0);
        this.a[0].h();
        this.a[0].a(v1, ((v2 + this.e()) - 3), (((this.e + v3) - v8) + 3));
        ...
        L807:
        v1.setClip((((this.e + v3) + 4) + ObfAq.d), (this.e() + v2), (this.a() - (2 * (4 + ObfAq.d))), this.b());
        v8 = ObfAq.d;
        v9 = 1;
        L853:
        ...
        return;
        L945:
        if (ObfAl.l() != 1) goto L1390;
        v1.setClip((((v6 - ((this.e + v3) - v8)) - this.a()) - v8), (this.e() + v2), (this.a() + v8), this.b());
        v1.setColor(5592405);
        ObfAq.a(v1, ((v6 - (this.e + v3)) - this.a()), (this.e() + v2), this.a(), this.b(), 8947848, 5592405, 0);
        if (this.d == 0) goto L1237;
        v1.setColor(10223616);
        ObfAq.a(v1, ((v6 - ((this.e + v3) - v8)) - v8), (this.e() + v2), v8, this.b(), 13565952, 10223616, 0);
        this.a[0].a(2);
        this.a[0].d(0);
        this.a[0].h();
        this.a[0].a(v1, ((v2 + this.e()) - 3), (((this.e + v3) - v8) + 3));
        ...
        L1237:
        v1.setClip((((v6 - (((this.e + v3) + 4) + ObfAq.d)) - this.a()) + (2 * (4 + ObfAq.d))), (this.e() + v2), (this.a() - (2 * (4 + ObfAq.d))), this.b());
        v8 = ObfAq.d;
        v9 = 1;
        L1299:
    ...
    public void i(int v1) {
        ...
        if (((this.f() + this.a[v1].f()) + this.a[v1].a()) <= (((((this.e + this.h) - ObfAq.d) - 6) - this.m) - 10)) goto L99;
        this.l = (this.l + ((((((this.e + this.h) - (v2 + this.a[v1].a())) - ObfAq.d) - 6) - this.m) - 10));
        return;
        L99:
        if (v2 >= (this.e + this.m)) goto L137;
        this.l = (this.l - (((v2 - this.e) - (2 * ObfCm.i)) - ObfAq.d));
        L137:
        return;
    }
    ...
    public boolean a(int v1) {
        ...
        if (ObfAq.b(v1) != 1) goto L62;
        this.a();
        goto L75;
        L62:
        if (ObfAq.b(v1) != 6) goto L75;
        this.b();
        L75:
        return 1;
        L77:
    ...
    public boolean b(int v1, int v2) {
        ...
        int v4 = ((((this.k - this.a()) + ObfAq.b.a(1)) + 7) + 30);
        if (((((this.k - this.a()) + ObfAq.b.a(1)) + 7) + 30) >= 70) goto L68;
        v4 = 0;
        L68:
